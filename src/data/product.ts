...
export const products: Product[] = [
    {
        ...
        description: [
            ...
            {
                index: "2 「次の勉強」につなげる",
                body: "解いた後に、AIがあなたに合った類題を生成！あなた専用の問題に挑戦！\n統計でどれだけ問題を解いたか確認！\n努力が可視化されて、モチベーションにつながる！\n選んだ類題には、すぐに挑戦できる！",
            },
            {
                index: "3 「手軽に」取り組める工夫",
    ...
    },
    {
        ...
        description: [
            ...
            },
            {
                ...
                body:
                    "私たちは大学で学んだプログラミング技術を現実の課題解決に活かすことを目的としています。今回のWebサイト制作は、学内で得た知識を社会に還元し、より多くの人々に想いを届けるための挑戦でした。\n\n" +
