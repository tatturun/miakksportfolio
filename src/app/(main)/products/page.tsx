    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row w-4/5 md:w-full max-w-7xl gap-8 mb-16">
                ...
                <div className="w-full md:w-1/4 overflow-x-auto md:overflow-y-auto md:h-[80vh] flex flex-row md:flex-col items-start space-x-4 md:space-x-0 md:space-y-4 p-4 custom-scrollbar">
