    ...
    return (
        <div className={`${styles.container} max-w-7xl mx-auto px-4`}>
            ...
            <p className={styles.specificDescription}>
                私たちMiakks(ミアキス)は、大学生のみで構成された、ソフトウェア開発チームです。
                <br></br>
                実際にさまざまなアプリを作る中で、プログラミングの楽しさや、人に役立つアプリを作る難しさなどを学んでいます！
                <br></br>
                アプリを作る際には、実際に使ってもらう人の声を大切に作っているので、ぜひ一度いずれかのアプリを使ってみて、感想を教えて下さい！
            </p>
